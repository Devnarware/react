...
function CardContent() {
  return (
    <div className="absolute top-0 h-full w-95 rounded-[50px] p-10 flex flex-col justify-between bg-gray-500">
        ...
        <div className="  text-2xl/10 font-sans font-stretch-120% font-light text-gray-100">
            ...
            <div className='flex justify-between items-center' >
                <button className='bg-blue-500 px-6 py-2 rounded-full text-white'>Satisfied</button>
                <button className='bg-blue-500 p-2 flex justify-center items-center rounded-full'>
