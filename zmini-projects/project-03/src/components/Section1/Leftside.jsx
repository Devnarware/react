...
function Leftside() {
  return (
    <div className="h-full w-1/3 ">
      <div className="text my-40 flex flex-col ">
        <h2 className='text-6xl/19 font-bold font-font-sans font-stretch-110% tracking-tight mb-15'>Prospective <span className='bg-gray-100 p-1 rounded-full'>customer</span> segmentation</h2>
