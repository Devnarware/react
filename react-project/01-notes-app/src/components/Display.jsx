        ...
        <div className='hide-scrollbar flex flex-wrap gap-9 h-245 overflow-y-auto'>
          ...
          {props.task?.map(function (elem, idx) {
            return (
              <div
                key={idx}
                className="h-104 w-75 rounded-2xl bg-[url('https://static.vecteezy.com/system/resources/previews/037/152/677/non_2x/sticky-note-paper-background-free-png.png')] bg-cover overflow-hidden px-10 pt-11 flex flex-col justify-between"
              >
